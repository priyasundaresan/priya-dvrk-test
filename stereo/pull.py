...
def pull(psm, points, y_offset, x_offset):
	points = [points[i:i + 2] for i in range(0, len(points), 2)]
	for pair in points:
		start, end = pair[0], pair[1]
		x1, y1, z1 = start[0]- x_offset, start[1]+ y_offset, start[2]
		x2, y2, z2 = end[0]- x_offset, end[1] + y_offset, end[2]
		print("Moving to:")
		print(start)
		psm.open_jaw()
		time.sleep(.1)
...
if __name__ == '__main__':
	...
	pos2 = PyKDL.Vector(-0.0972128,  -0.0170138,   -0.09)
